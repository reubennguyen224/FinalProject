...
class RecyclerViewLoadMoreScroll(layoutManger: GridLayoutManager) : RecyclerView.OnScrollListener(){
    ...
    override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
        ...
        lastVisibleProductPosition = (homeLayoutManager as GridLayoutManager).findLastVisibleItemPosition()
